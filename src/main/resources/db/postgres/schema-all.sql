...
VALUES (9, 'Cnpj Invalido', true) ON CONFLICT (business_type_id) DO NOTHING;
INSERT INTO sites (site_code, longitude, latitude)
VALUES ('UNDEFINED', 0, 0) ON CONFLICT (site_code) DO NOTHING;
INSERT INTO customers (customer_id, email_address, name, business_type_id, default_site_code, archived, is_key_account,
                       date_updated, date_created)
VALUES (0, 'generic@example.com', 'Undefined Customer', 9, 'UNDEFINED', FALSE, FALSE, NOW(), NOW()) ON CONFLICT (customer_id) DO NOTHING;
